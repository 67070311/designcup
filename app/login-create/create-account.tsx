...
export default function CreateAccount({ onLogin, onClose }: CreateAccountProps) {
  return (
    <section className="relative w-[min(1080px,calc(100vw-40px))] rounded-[20px] bg-white p-[26px] text-[16px] shadow-[0_24px_70px_rgba(0,0,0,0.18)] sm:p-[30px]">
      ...
      <div className="grid min-h-[536px] grid-cols-1 gap-8 lg:grid-cols-[1fr_493px] lg:gap-[54px]">
        <div className="order-2 flex items-start justify-center px-5 py-12 lg:order-1 lg:px-[48px] lg:py-[42px] lg:pl-[54px]">
          <div className="w-full max-w-[432px]">
            <h1 className="text-center text-[24px] font-semibold tracking-[-0.3px] text-black">
              Join the Next Design Challenge
            </h1>
            <p className="mx-auto mt-[15px] max-w-[385px] text-center text-[16px] leading-[1.65] text-[#8F8F8F]">
              Compete with designers worldwide, showcase your
              <br className="hidden sm:block" /> work, and earn recognition.
            </p>
            ...
            <p className="mt-[20px] text-center text-[16px] leading-[1.55] text-[#777777]">
              By creating an account, you agree to our{" "}
              <button type="button" className="text-[#287CFF] underline underline-offset-2">
                Terms
              </button>{" "}
              &amp;{" "}
              <button type="button" className="text-[#287CFF] underline underline-offset-2">
            ...
            <div className="mt-[38px] h-px w-full bg-[#ECECEC]" />

            <p className="mt-[36px] text-center text-[16px] text-[#8D8D8D]">
        ...
        {/* Replace this block with the create-account illustration later. */}
        <div className="order-1 min-h-[320px] rounded-[20px] bg-[#DDF7FF] lg:order-2 lg:min-h-[536px]" />
      </div>
    </section>
  );
}
